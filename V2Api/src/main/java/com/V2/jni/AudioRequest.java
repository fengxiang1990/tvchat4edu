...
public class AudioRequest {
	...
	public native void AudioSetAecm(boolean bAec);

	// nMode: 0-lowest, 4-highest suppression
	public native void AudioSetAecmMode(int nMode);

	public native void AudioSetAgc(boolean bAgc);

	// nGain: 1-normal, greater than 1 - amplified
	public native void AudioSetMicGain(int nGain);
	
	// nLevel: 0-3, noise suppression level
	public native void AudioSetNs(boolean bNs, int nLevel);
