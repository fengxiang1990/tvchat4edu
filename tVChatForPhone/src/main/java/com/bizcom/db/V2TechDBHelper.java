...
public class V2TechDBHelper extends SQLiteOpenHelper {
    ...
    private static final String HISTORIES_GRAPHIC_TABLE_CREATE_SQL = " create table  "
            ...
            + ContentDescriptor.HistoriesGraphic.Cols.OWNER_USER_ID
            + " bigint,"
            ...
            + " nvarchar(4000), "
            + ContentDescriptor.HistoriesGraphic.Cols.HISTORY_MESSAGE_ID
            + " nvarchar(4000), "
    ...
    private static final String HISTORIES_AUDIOS_TABLE_CREATE_SQL = " create table  "
            ...
            + "  integer primary key AUTOINCREMENT,"
            + ContentDescriptor.HistoriesAudios.Cols.OWNER_USER_ID
            + " bigint,"
            ...
            + " nvarchar(4000), "
            + ContentDescriptor.HistoriesAudios.Cols.HISTORY_MESSAGE_ID
            + " nvarchar(4000), "
    ...
    private static final String HISTORIES_FILES_TABLE_CREATE_SQL = " create table  "
            ...
            + "  integer primary key AUTOINCREMENT,"
            + ContentDescriptor.HistoriesFiles.Cols.OWNER_USER_ID
            + " bigint,"
            ...
            + " nvarchar(4000), "
            + ContentDescriptor.HistoriesFiles.Cols.HISTORY_MESSAGE_ID
            + " nvarchar(4000), "
            + ContentDescriptor.HistoriesFiles.Cols.HISTORY_FILE_PATH
            + " nvarchar(4000), "
            + ContentDescriptor.HistoriesFiles.Cols.HISTORY_FILE_SEND_STATE
            + " bigint, "
            // + ContentDescriptor.HistoriesFiles.Cols.HISTORY_FILE_READ_STATE +
            // " bigint, "
            + ContentDescriptor.HistoriesFiles.Cols.HISTORY_FILE_SIZE
            + " bigint)";
    ...
    private static final String HISTORIES_MEDIA_TABLE_CREATE_SQL = " create table  "
            ...
            + "  integer primary key AUTOINCREMENT,"
            + ContentDescriptor.HistoriesMedia.Cols.OWNER_USER_ID
            + " bigint,"
            + ContentDescriptor.HistoriesMedia.Cols.HISTORY_MEDIA_SAVEDATE
            + " bigint,"
            + ContentDescriptor.HistoriesMedia.Cols.HISTORY_MEDIA_CHAT_ID
            + " nvarchar(4000),"
            ...
            + " bigint, "
            + ContentDescriptor.HistoriesMedia.Cols.HISTORY_MEDIA_TYPE
            + " bigint, "
            + ContentDescriptor.HistoriesMedia.Cols.HISTORY_MEDIA_STATE
            + " bigint, "
            ...
            + " bigint,"
            + ContentDescriptor.HistoriesMedia.Cols.CANCEL_BY_MINE
            + " bigint,"
    ...
    private static final String HISTORIES_ADD_FRIENT_TABLE_CREATE_SQL = " create table  "
            ...
            + "  integer primary key AUTOINCREMENT,"
            + ContentDescriptor.HistoriesAddFriends.Cols.OWNER_USER_ID
            + " bigint,"
            + ContentDescriptor.HistoriesAddFriends.Cols.HISTORY_FRIEND_SAVEDATE
            + " bigint,"
            + ContentDescriptor.HistoriesAddFriends.Cols.HISTORY_FRIEND_FROM_USER_ID
            + " bigint,"
            + ContentDescriptor.HistoriesAddFriends.Cols.HISTORY_FRIEND_AUTHTYPE
            + " bigint,"
            ...
            + " nvarchar(4000), "
            + ContentDescriptor.HistoriesAddFriends.Cols.HISTORY_FRIEND_APPLY_REASON
            + " nvarchar(4000), "
            + ContentDescriptor.HistoriesAddFriends.Cols.HISTORY_FRIEND_REFUSE_REASON
            + " nvarchar(4000), "
    ...
    private static final String HISTORIES_CROWD_TABLE_CREATE_SQL = " create table  "
            ...
            + "  integer primary key AUTOINCREMENT,"
            + ContentDescriptor.HistoriesCrowd.Cols.OWNER_USER_ID
            + " bigint,"
            ...
            + " bigint, "
            + ContentDescriptor.HistoriesCrowd.Cols.HISTORY_CROWD_REMOTE_USER_NICK_NAME
            + " nvarchar(4000), "
            ...
            + " bigint)";
    private static final String HISTORIES_CONFINVITE_TABLE_CREATE_SQL = " create table  "
            + ContentDescriptor.HistoriesConfInvites.NAME
            + " ( "
            + ContentDescriptor.HistoriesConfInvites.Cols.ID
            + "  integer primary key AUTOINCREMENT,"
            + ContentDescriptor.HistoriesConfInvites.Cols.OWNER_USER_ID
            + " bigint,"
            + ContentDescriptor.HistoriesConfInvites.Cols.HISTORY_CONFINVITE_SAVEDATE
            + " bigint,"
            + ContentDescriptor.HistoriesConfInvites.Cols.HISTORY_CONFINVITE_ID
            + " bigint,"
            + ContentDescriptor.HistoriesConfInvites.Cols.HISTORY_CONFINVITE_REMOTE_USER_ID
            + " bigint,"
            + ContentDescriptor.HistoriesConfInvites.Cols.HISTORY_CONFINVITE_USER_BASE_INFO
            + " nvarchar(4000), "
            + ContentDescriptor.HistoriesConfInvites.Cols.HISTORY_CONFINVITE_CONF_BASE_INFO
            + " nvarchar(4000), "
            + ContentDescriptor.HistoriesConfInvites.Cols.HISTORY_CONFINVITE_READ_STATE
            + " bigint)";

    private V2TechDBHelper(DataBaseContext context) {
        super(context, DB_NAME, null, DATABASE_VERSION);
    }

    private static V2TechDBHelper helper;

    public static V2TechDBHelper getInstance(DataBaseContext context) {
        if (helper == null) {
            synchronized (V2TechDBHelper.class) {
                if (helper == null) {
                    helper = new V2TechDBHelper(context);
                }
            }
        }
        return helper;
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(HISTORIES_CONFINVITE_TABLE_CREATE_SQL);
    }
