...
public class JNIResponse {
	...
	public enum Result {
		SUCCESS(0), FAILED(1), NO_RESOURCE(2), LOGED_OVER_TIME(3), LOGED_ORG_DISABLE(4), LOGED_USER_DISABLE(5) , CONNECT_ERROR(
				301), SERVER_REJECT(300), UNKNOWN(-1), TIME_OUT(-2), INCORRECT_PAR(-3), ERR_CONF_NO_EXIST(
						200), ERR_CONF_LOCKDOG_NORESOURCE(205);
