...
public class EmojiIndicatorView extends LinearLayout {
    ...
    public EmojiIndicatorView(Context context, AttributeSet attrs) {
        ...
        mMaxHeight = DensityUtils.dip2px(mContext, mHeight);
        bmpSelect= BitmapFactory.decodeResource(getResources(), R.drawable.dot_gray);
        bmpNomal= BitmapFactory.decodeResource(getResources(), R.drawable.dot_white);
    }
