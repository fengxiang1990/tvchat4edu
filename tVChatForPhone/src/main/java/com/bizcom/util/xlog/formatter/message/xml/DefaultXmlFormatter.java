...
package com.bizcom.util.xlog.formatter.message.xml;


import com.bizcom.util.xlog.*;
import com.bizcom.util.xlog.formatter.FormatException;
...
public class DefaultXmlFormatter implements XmlFormatter {
    ...
    public String format(String xml) {
        ...
        try {
            ...
            formattedString = xmlOutput.getWriter().toString().replaceFirst(">", ">" + com.bizcom.util.xlog.System.lineSeparator);
        } catch (Exception e) {
