...
package com.bizcom.util.xlog.printer;


import com.bizcom.util.xlog.border.BorderConfiguration;
...
public abstract class MessageBorderedPrinter extends MessageFormattedPrinter {
    ...
    private String borderMsgIfNecessary(String msg) {
        if (borderConfiguration.isEnabled) {
            ...
            String[] lines = msg.split(com.bizcom.util.xlog.System.lineSeparator);
            for (String line : lines) {
                msgWithVerticalBorderBuilder.append(borderConfiguration.verticalBorderChar).append(line).append(com.bizcom.util.xlog.System.lineSeparator);
            }
            ...
            messageBuilder
                    .append(topHorizontalBorder).append(com.bizcom.util.xlog.System.lineSeparator)
