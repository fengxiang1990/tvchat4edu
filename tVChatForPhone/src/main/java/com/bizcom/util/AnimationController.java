...
//			parent.removeView(view);
	...
	public static void arrowRotateDown(View view , int duration , int from , int to) {
		RotateAnimation animation = new RotateAnimation(from, to, rela1, 0.5f, rela1, 0.5f);
		animation.setFillAfter(true);
		baseIn(view, animation, duration, 0);
	}

	public static void arrowRotateRight(View view , int duration , int from , int to) {
		RotateAnimation animation = new RotateAnimation(from, to, rela1, 0.5f, rela1, 0.5f);
		animation.setFillAfter(true);
		baseOut(view, animation, duration, 0);
	}
}
