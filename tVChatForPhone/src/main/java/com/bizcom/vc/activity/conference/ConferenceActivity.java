...
public class ConferenceActivity extends BaseActivity implements CommonNotifyChatInterToReplace {
...
//        }
    ...
    private boolean initConferenceDate() {
        ...
        currentAttendee.setChairMan(GlobalHolder.getInstance().findGroupById(conf.getId()).getOwnerUser()
    ...
    private void showLocalSurViewOnly() {
        ...
        if (captureInfo != null) {
            ...
            GlobalConfig.setGlobalVideoLevel(mContext, level);
//            openLocalCamera();
    ...
    private SurfaceViewConfig addSurfaceView(UserDeviceConfig udc) {
        ...
        surfaceChild.setZOrderMediaOverlay(false);
    ...
    public boolean openAttendeeVideo(UserDeviceConfig udc) {
        ...
        if (sw != null) {
            ...
            V2Log.e(TAG, "openAttendeeVideo --> can't sendFriendToTv a new surfaceview , get null!");
            return false;
        }
...
//            }
                ...
                conferenceMessage.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        ...
                        if (mHostRequestUsers != null && mHostRequestUsers.size() > 0) {
                            ...
                            Toast.makeText(ConferenceActivity.this, R.string.conference_toast_no_meeting,
    ...
    private void initMorePopupWindow() {
        ...
        moreWindow = new PopupWindow(layout, ViewGroup.LayoutParams.WRAP_CONTENT, height, true);
