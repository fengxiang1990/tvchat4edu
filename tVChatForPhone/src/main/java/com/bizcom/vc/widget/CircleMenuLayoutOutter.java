 ...
 * </pre>
 */
public class CircleMenuLayoutOutter extends ViewGroup {
	private int mRadius;
	/**
	 * 该容器内child item的默认尺寸
	 */
	...
	public CircleMenuLayoutOutter(Context context, AttributeSet attrs) {
		super(context, attrs);		
		setClickable(true);
	}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		for (int i = 0; i < childCount; i++) {
			...
			float tmp = layoutRadius / 2  - mPadding;
	...
	private void addMenuItems() {
		...
		for (int i = 0; i < mMenuItemCount; i++) {
			...
			if (mItemImgs[i] == R.drawable.btn_theme1_selector || mItemImgs[i] == R.drawable.btn_theme2_selector
					|| mItemImgs[i] == R.drawable.btn_theme3_selector) {
				cbs.add(iv);
			}
