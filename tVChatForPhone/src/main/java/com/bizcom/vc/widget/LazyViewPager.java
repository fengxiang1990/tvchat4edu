...
public class LazyViewPager extends ViewGroup {
	 ...
	 * {@link com.bizcom.vc.widget.LazyViewPager.OnPageChangeListener}
	...
	public void addFocusables(ArrayList<View> views, int direction,
		...
		// we sendFriendToTv ourselves (if focusable) in all cases except for when we are
		...
		// No focusable descendants
			...
			// sendFriendToTv all views in. So we need to do the same thing View does.
			if (!isFocusable()) {
				return;
			}
