...
public final class GlobalState {
	...
	/**
	 * Use to mark chat interface is open
	 */
	public static final int STATE_CHAT_INTERFACE_OPEN = 0x08000;
	...
	public long getRemoteChatUid() {
		return remoteChatUid;
	}

	public void setRemoteChatUid(long remoteChatUid) {
		this.remoteChatUid = remoteChatUid;
	}
	...
	public boolean isChatInterfaceOpen() {
		return (state & STATE_CHAT_INTERFACE_OPEN) == STATE_CHAT_INTERFACE_OPEN;
	}
}
